      ...
      <section className="py-20 bg-gradient-to-b from-primary/5 to-transparent">
        <div className="container mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-3xl mx-auto mb-16">
            <h1 className="text-4xl font-bold mb-3 tracking-tight" style={{ fontFamily: "Montserrat, sans-serif" }}>Our Apps</h1>
            <div className="mx-auto w-24 h-1 rounded bg-secondary mb-5" />
            <p className="text-xl text-muted-foreground">A curated gallery of GS applications and platforms</p>
          </div>
              ...
              <Card key={i} className="hover-elevate active-elevate-2 transition-all duration-300">
                ...
                <CardContent>
                  ...
                  <a href={app.href} target="_blank" rel="noopener noreferrer">
                    <Button variant="ghost" className="p-0 h-auto font-semibold text-secondary">Visit <ArrowRight className="ml-2 h-4 w-4" /></Button>
                  </a>
                </CardContent>
              </Card>
            ))}
