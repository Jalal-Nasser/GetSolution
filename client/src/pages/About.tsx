          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center mb-20">
            ...
            <h2 className="text-2xl font-bold mb-6" style={{ fontFamily: "Montserrat, sans-serif" }} data-testid="text-story-title">
              ...
              <div className="space-y-4 text-lg text-muted-foreground">
                ...
                <p data-testid="text-story-para-3">{t("about.storyPara3")}</p>
              </div>
            </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            <Card className="p-8" data-testid="card-mission">
              <div className="flex items-center gap-4 mb-4">
                ...
                <CardTitle className="text-2xl" style={{ fontFamily: "Montserrat, sans-serif" }} data-testid="text-mission-title">{t("about.mission")}</CardTitle>
              </div>
            ...
            <Card className="p-8" data-testid="card-vision">
              <div className="flex items-center gap-4 mb-4">
                ...
                <CardTitle className="text-2xl" style={{ fontFamily: "Montserrat, sans-serif" }} data-testid="text-vision-title">{t("about.vision")}</CardTitle>
              </div>
